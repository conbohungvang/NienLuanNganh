...
public class GiaoDienNhanVien extends javax.swing.JFrame {
    ...
    public GiaoDienNhanVien(String ten) {
        initComponents();
    ...
    class HienThi extends Thread {
        ...
        public void run() {
            while (true) {
                try {System.out.println("Chayjjjjjjjj");
    ...
    public void napThongTinThietBi(String vitri, String trangthai) {
        for (ThietBi thietBi : Client.danhSachThietBi) {
            /*danhSachThietBi Lấy trực tiếp từ Client*/
    ...
    private void initComponents() {
        ...
        comboBoxTrangThai.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Hư hỏng", "Đang sửa", "Bình thường" }));
    ...
    private void btnReportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReportActionPerformed
        try {
            int MaTB = (int) tbtb.getValueAt(tbtb.getSelectedRow(), 0);
            String vitri = (String) tbtb.getValueAt(tbtb.getSelectedRow(), 2);

            GiaoDienTaoBaoCao form = new GiaoDienTaoBaoCao(MaTB, tenNguoiDung, vitri);
            form.setVisible(true);
        } catch (ArrayIndexOutOfBoundsException ex) {
            GiaoDienTaoBaoCao form = new GiaoDienTaoBaoCao(tenNguoiDung);
            form.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new GiaoDienNhanVien(tenNguoiDung).setVisible(true);
            }
        });
    }
